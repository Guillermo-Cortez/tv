...
class BroadcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create broadcast" do
    assert_difference('Broadcast.count') do
      post broadcasts_url, params: { broadcast: { date: @broadcast.date, number: @broadcast.number } }
    end
  ...
  test "should update broadcast" do
    patch broadcast_url(@broadcast), params: { broadcast: { date: @broadcast.date, number: @broadcast.number } }
